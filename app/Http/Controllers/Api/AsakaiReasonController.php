    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'section' => 'nullable|in:No Section,Brazing,Chassis,Nylon,Subcon,Passthrough,PPIC,Logistics,Service Parts,Quality Control,Quality Assurance,Engineering,Maintenance,Purchasing,Warehouse,Marketing,HRD,General Affairs,Information Technology,Safety,Accounting,Jishuken',
